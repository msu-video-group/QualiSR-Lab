...
def main():
    ...
    parser = argparse.ArgumentParser(description="Run SPAN upscaling on a single image.")
    parser.add_argument("--ckpt", default="./span-tuned-4x.pth", help="Path to the model checkpoint.")
    parser.add_argument("--image", required=True, help="Path to the input image.")
    parser.add_argument("--output", required=True, help="Path to save the output image.")
    parser.add_argument("--scale", type=int, default=4, help="Upscale factor for SPAN.")
